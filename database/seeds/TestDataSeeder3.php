...
class TestDataSeeder3 extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $this->execute("
            ...
            VALUES
                ('ba0b3f1n0', 'BA0B3F1N0', 'A', 'A', 'ba0b3f1n0@example.com', '555-0001', 1, 2, 'Yes', 'Yes',
                 (SELECT id FROM users WHERE email = 'ba0b3f1n0@example.com')),
                ('ba0b3f1n1', 'BA0B3F1N1', 'B', 'A', 'ba0b3f1n1@example.com', '555-0001', 1, 3, 'No', 'Yes',
                ...
                ('ba0b5f1n0', 'BA0B5F1N0', 'D', 'A', 'ba0b5f1n0@example.com', '555-0001', 1, 4, 'Yes', 'Yes',
                 (SELECT id FROM users WHERE email = 'ba0b5f1n0@example.com')),
                ('ba1b2f1n0', 'BA1B2F1N0', 'E', 'A', 'ba1b2f1n0@example.com', '555-0001', 1, 3, 'No', 'Yes',
                 (SELECT id FROM users WHERE email = 'ba1b2f1n0@example.com')),
                ('ba1b4f1n0', 'BA1B4F1N0', 'F', 'A', 'ba1b4f1n0@example.com', '555-0001', 1, 5, 'No', 'Yes',
        ...
        $this->execute("
            ...
            VALUES
                ('cm0s0f1n0', 'CM0S0F1N0', 'C', 'M0S0F1N0', 'cm0s0f1n0@example.com', '613-555-1212', 0, '',
                 (SELECT id FROM users WHERE email = 'cm0s0f1n0@example.com')),
                ('cm0s0f1n1', 'CM0S0F1N1', 'C', 'M0S0F1N1', 'cm0s0f1n1@example.com', '613-555-1212', 1, '',
                 (SELECT id FROM users WHERE email = 'cm0s0f1n1@example.com')),
                ('cm0s1f1n0', 'CM0S1F1N0', 'C', 'M0S1F1N0', 'cm0s1f1n0@example.com', '613-555-1212', 2, '',
                 (SELECT id FROM users WHERE email = 'cm0s1f1n0@example.com')),
                ('cm0s1f1n1', 'CM0S1F1N1', 'C', 'M0S1F1N1', 'cm0s1f1n1@example.com', '613-555-1212', 0, '',
                 (SELECT id FROM users WHERE email = 'cm0s1f1n1@example.com')),
                ('cm0s2f1n0', 'CM0S2F1N0', 'C', 'M0S2F1N0', 'cm0s2f1n0@example.com', '613-555-1212', 2, '',
                 (SELECT id FROM users WHERE email = 'cm0s2f1n0@example.com')),
                ('cm0s2f1n1', 'CM0S2F1N1', 'C', 'M0S2F1N1', 'cm0s2f1n1@example.com', '613-555-1212', 2, '',
                 (SELECT id FROM users WHERE email = 'cm0s2f1n1@example.com')),
                ('cm1s0f0n0', 'CM1S0F0N0', 'C', 'M1S0F0N0', 'cm1s0f0n0@example.com', '613-555-1212', 0, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f0n0@example.com')),
                ('cm1s0f0n1', 'CM1S0F0N1', 'C', 'M1S0F0N1', 'cm1s0f0n1@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f0n1@example.com')),
                ('cm1s0f1n0', 'CM1S0F1N0', 'C', 'M1S0F1N0', 'cm1s0f1n0@example.com', '613-555-1212', 2, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f1n0@example.com')),
                ('cm1s0f1n1', 'CM1S0F1N1', 'C', 'M1S0F1N1', 'cm1s0f1n1@example.com', '613-555-1212', 0, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f1n1@example.com')),
                ('cm1s0f1n2', 'CM1S0F1N2', 'C', 'M1S0F1N2', 'cm1s0f1n2@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f1n2@example.com')),
                ('cm1s0f1n3', 'CM1S0F1N3', 'C', 'M1S0F1N3', 'cm1s0f1n3@example.com', '613-555-1212', 2, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s0f1n3@example.com')),
                ('cm1s1f1n0', 'CM1S1F1N0', 'C', 'M1S1F1N0', 'cm1s1f1n0@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n0@example.com')),
                ('cm1s1f1n1', 'CM1S1F1N1', 'C', 'M1S1F1N1', 'cm1s1f1n1@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n1@example.com')),
                ('cm1s1f1n2', 'CM1S1F1N2', 'C', 'M1S1F1N2', 'cm1s1f1n2@example.com', '613-555-1212', 2, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n2@example.com')),
                ('cm1s1f1n3', 'CM1S1F1N3', 'C', 'M1S1F1N3', 'cm1s1f1n3@example.com', '613-555-1212', 0, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n3@example.com')),
                ('cm1s1f1n4', 'CM1S1F1N4', 'C', 'M1S1F1N4', 'cm1s1f1n4@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n4@example.com')),
                ('cm1s1f1n5', 'CM1S1F1N5', 'C', 'M1S1F1N5', 'cm1s1f1n5@example.com', '613-555-1212', 2, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s1f1n5@example.com')),
                ('cm1s2f1n0', 'CM1S2F1N0', 'C', 'M1S2F1N0', 'cm1s2f1n0@example.com', '613-555-1212', 0, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s2f1n0@example.com')),
                ('cm1s2f1n1', 'CM1S2F1N1', 'C', 'M1S2F1N1', 'cm1s2f1n1@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s2f1n1@example.com')),
                ('cm1s2f1n2', 'CM1S2F1N2', 'C', 'M1S2F1N2', 'cm1s2f1n2@example.com', '613-555-1212', 2, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s2f1n2@example.com')),
                ('cm1s2f1n3', 'CM1S2F1N3', 'C', 'M1S2F1N3', 'cm1s2f1n3@example.com', '613-555-1212', 0, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s2f1n3@example.com')),
                ('cm1s2f1n4', 'CM1S2F1N4', 'C', 'M1S2F1N4', 'cm1s2f1n4@example.com', '613-555-1212', 1, '111111',
                 (SELECT id FROM users WHERE email = 'cm1s2f1n4@example.com')),
                ('cm1s2f1n5', 'CM1S2F1N5', 'C', 'M1S2F1N5', 'cm1s2f1n5@example.com', '613-555-1212', 2, '111111',
